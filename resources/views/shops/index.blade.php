                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('shops.store') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="number" class="form-control" placeholder="رقم المتجر"
                                            required>
                                    </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row first-row-links">
                                        <a href="{{ route('shops.show', ['shop' => $shop->id]) }}" class="">أكواد
                                            الخصم</a>
                                    ...
                                    <div class="row second-row-links">
                                        <button type="button" class="edit-btn" data-toggle="modal"
                                            data-target="#editModal" data-shop-id="{{ $shop->id }}">تعديل</button>
