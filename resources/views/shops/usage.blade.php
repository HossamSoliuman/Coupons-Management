...
@section('content')
    <div class="container mt-5">
        <div class="row justify-content-center mt-5">
            <div class="col-md-11">
                <h1>{{ $shop->name }} Offers usages deatails</h1>
                <div class="mb-3">
                    <a href="{{ route('shop.export.pdf', ['shop' => $shop->id]) }}" class="btn btn-dark btn-sm">Export as
                        PDF</a>
                    <a href="{{ route('shop.export.excel', ['shop' => $shop->id]) }}" class="btn btn-dark btn-sm">Export as
                        Excel</a>
                </div>
                <table class="table">
                    <thead>
